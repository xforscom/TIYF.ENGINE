...
- [Strategy Promotion Framework](docs/PROMOTION-FRAMEWORK.md) – Runtime performance-based strategy selection and promotion/demotion policies.
...
> **Note**: This section describes **config promotion** (deterministic A/B testing
> and gating of configuration changes). For **strategy promotion** (runtime
> performance-based strategy selection), see [docs/PROMOTION-FRAMEWORK.md](docs/PROMOTION-FRAMEWORK.md).
